...
class BoletoOfflineTeste extends StatefulWidget {
  const BoletoOfflineTeste({Key? key}) : super(key: key);

  @override
  State<BoletoOfflineTeste> createState() => _BoletoOfflineTesteState();
}

class _BoletoOfflineTesteState extends State<BoletoOfflineTeste> {
  ...
  Widget build(BuildContext context) {
    ...
    final balizaCounter = CustomBalizaCounter(
      balizaDisplayTime: balizaDisplayTime,
        ...
        child: Row(
          children: [
            ...
            InkWell(
              onTap: () {
                setState(() {
                  print(balizaDisplayTime);
                  Navigator.pushNamed(context, '/exameFinalizado', arguments: {
                    "nome": nome,
                    "localDoExame": localDoExame,
                    "categoria": categoria,
                    "unidadeDeTransito": unidadeDeTransito,
  ...
  List<FaltasEliminatorias> faltasEliminatorias = [
    ...
    FaltasEliminatorias(id: 6, checkboxState: false, nome: "Não completar a realização de todas as etapas do exame"),
    ...
    FaltasEliminatorias(
        id: 10, checkboxState: false, nome: "Cometer qualquer outra infração de trânsito de natureza gravíssima"),
  ];
  ...
  List<FaltasGerais> faltasMedias = [
    FaltasGerais(
        id: 1,
        nome: "Executar o percurso da prova, no todo, ou parte dele sem estar com o freio de mão inteiramente livre",
        falta1: false,
        falta2: false,
        falta3: false,
        falta4: false),
    ...
    FaltasGerais(
        ...
        falta4: false),
    FaltasGerais(
        id: 4, nome: "Fazer a conversão incorretamente", falta1: false, falta2: false, falta3: false, falta4: false),
    FaltasGerais(
        id: 5,
        ...
        falta4: false),
    FaltasGerais(
        id: 6, nome: "Desengrenar o veículo nos declives", falta1: false, falta2: false, falta3: false, falta4: false),
    FaltasGerais(
        id: 7,
...
class BoletoItem extends StatelessWidget {
  BoletoItem({Key? key, required this.itemName, this.fontSize = 20}) : super(key: key);
