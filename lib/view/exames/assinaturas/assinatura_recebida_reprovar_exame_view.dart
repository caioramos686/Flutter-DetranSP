...
class AssinaturaRecebidaReprovarExame extends StatelessWidget {
  const AssinaturaRecebidaReprovarExame({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      ...
      body: Column(
        ...
        children: [
          const CustomAlertSucess(text: "Exame reprovado com sucesso!"),
          const SizedBox(
            height: 100,
          ),
