import 'package:boleto_digital/widgets/custom_baliza_observations.dart';
...
class Boleto extends StatefulWidget {
  const Boleto({Key? key}) : super(key: key);
...
class _BoletoState extends State<Boleto> {
  ...
  List<FaltasEliminatorias> faltasEliminatorias = [
    FaltasEliminatorias(
        id: 1,
        checkboxState: false,
        nome: "Desobedecer à sinalização semafórica e de parada obrigatória"),
    FaltasEliminatorias(
        id: 2, checkboxState: false, nome: "Avançar sobre o meio-fio"),
    FaltasEliminatorias(
        id: 3,
        checkboxState: false,
        nome:
    ...
    FaltasEliminatorias(
        id: 5, checkboxState: false, nome: "Transitar em contramão de direção"),
    FaltasEliminatorias(
        id: 6,
        checkboxState: false,
        nome: "Não completar a realização de todas as etapas do exame"),
    FaltasEliminatorias(
        id: 7, checkboxState: false, nome: "Avançar a via preferencial"),
    FaltasEliminatorias(
        id: 8,
        checkboxState: false,
        nome: "Provocar acidente durante a realização do exame"),
    FaltasEliminatorias(
        id: 9,
        checkboxState: false,
        nome: "Exceder a velocidade regulamente para a via"),
    FaltasEliminatorias(
        id: 10,
        checkboxState: false,
        nome:
  ...
  List<FaltasGerais> faltasMedias = [
    ...
    FaltasGerais(
        id: 10,
        nome:
            "Engrenar ou utilizar marchas de maneira incorreta durante o percurso",
        falta1: false,
        falta2: false,
        falta3: false,
        falta4: false),
  ...
  List<FaltasGerais> faltasGraves = [
    ...
    FaltasGerais(
        id: 5,
        nome:
            "Não sinalizar com antecedência a manobra pretendida ou sinalizâ-la incorretamente",
        falta1: false,
        falta2: false,
        falta3: false,
        falta4: false),
